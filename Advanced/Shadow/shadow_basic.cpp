// sombrasMain.cpp: define el punto de entrada de la aplicación de consola.
//
...
int main()
{
	...
	// -------------------------
	Shader shader("res/shaders/shadow_mapping.vs", "res/shaders/shadow_mapping.frag");
	Shader simpleDepthShader("res/shaders/shadow_mapping_depth.vs", "res/shaders/shadow_mapping_depth.frag");
	Shader debugDepthQuad("res/shaders/debug_quad.vs", "res/shaders/debug_quad_depth.frag");
